...
- [x] `npm -v` mostra um número
- [x] O ícone da baleia está parado na barra de tarefas
- [x] `docker -v` mostra a versão
- [x] `docker compose version` mostra a versão
- [x] `docker run --rm hello-world` mostrou "Hello from Docker!"
