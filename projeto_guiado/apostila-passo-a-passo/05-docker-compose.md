...
- [x] Etapa 04 concluída (`Dockerfile` criado)
...
- [x] O arquivo se chama `docker-compose.yml`
- [x] Tem dois serviços: `db` e `api`
- [x] Tem a seção `volumes:` no final
- [x] `docker compose config` não mostrou erro
- [x] As variáveis apareceram substituídas pelos valores reais
