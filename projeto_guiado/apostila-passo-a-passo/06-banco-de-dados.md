...
- [x] Etapa 05 concluída (`docker-compose.yml` criado)
...
- [x] O arquivo está em `database/init.sql` (dentro da pasta, não na raiz)
- [x] Tem 3 comandos `CREATE TABLE`
- [x] Tem 3 comandos `CREATE INDEX`
- [x] Tem 3 comandos `INSERT INTO`
- [x] Todo comando termina com ponto e vírgula `;`
- [x] Os preços usam **ponto** decimal (`28.00`), não vírgula
- [x] Não há acentos nos dados
